...
void Motion::Forward(const char cID[2], unsigned char ucSpeed)
{ 
    char c_ID; 
...
void Motion::Reverse(const char cID[2],unsigned char ucSpeed)
{
	char c_ID; 
...
void Motion::Left(const char cID[2],unsigned char ucSpeed)
{
	char c_ID; 
...
void Motion::Right(const char cID[2],unsigned char ucSpeed)
{
	char c_ID; 
