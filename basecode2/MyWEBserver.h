    ...
    if (this.readyState == 4 && this.status == 200)
    {
     ...
     if(vWorkingName.length > 1)
     {
       ...
       document.getElementById("HaltContinuous").checked = true;
         ...
         if(vWorkingName[WatchIndexer] == "BPCN")
         {
           WatchVariableColIndex = 7;
           WatchVarableRowIndex = 7;
         }
         ...
         if(WatchVariableColIndex == 10)
         {
          ...
          {
            ChartLowerLimits[ChartVariableIndex] = vWorkingName[WatchIndexer];
          }
          else
          {
            ChartUpperLimits[ChartVariableIndex] = vWorkingName[WatchIndexer];
          }
            WatchVariableColIndex = 7;
         }
         if(vWorkingName[WatchIndexer] == "LL1")
         {
           WatchVariableColIndex = 10;
           WatchVarableRowIndex = 7;
           ChartVariableIndex = 0;
           UpperLowerLimit = 0;
         }
         if(vWorkingName[WatchIndexer] == "UU1")
         {
           WatchVariableColIndex = 10;
           WatchVarableRowIndex = 7;
           ChartVariableIndex = 0;
         ...
         if(vWorkingName[WatchIndexer] == "UU2")
         {
           WatchVariableColIndex = 10;
           WatchVarableRowIndex = 7;
           ChartVariableIndex = 1;
         ...
         if(vWorkingName[WatchIndexer] == "UU3")
         {
           WatchVariableColIndex = 10;
           WatchVarableRowIndex = 7;
           ChartVariableIndex = 2;
         ...
         if(vWorkingName[WatchIndexer] == "UU4")
         {
           WatchVariableColIndex = 10;
           WatchVarableRowIndex = 7;
           ChartVariableIndex = 3;
         ...
         if(vWorkingName[WatchIndexer] == "UU5")
         {
           WatchVariableColIndex = 10;
           WatchVarableRowIndex = 7;
           ChartVariableIndex = 4;
         ...
         if(vWorkingName[WatchIndexer] == "UU6")
         {
           WatchVariableColIndex = 10;
           WatchVarableRowIndex = 7;
           ChartVariableIndex = 5;
         ...
         if(WatchVariableColIndex < 7)
         {
           ...
           {
            if(WatchVarableRowIndex == 7)
            {
              WVNC[WatchVariableColIndex].innerHTML = vWorkingName[WatchIndexer];
            }
            else
            {
    ...
    if (this.readyState == 4 && this.status == 200)
    {
     ...
     if(vWorkingData.length > 1)
     {
       for (WatchIndexer=0;WatchIndexer<vWorkingData.length;WatchIndexer++)  
       {
         ...
         if(vWorkingData[WatchIndexer] == "BPC")
         {
           WatchVariableColIndex = 7;
           WatchVarableRowIndex = 7;
         }
         if(vWorkingData[WatchIndexer] == "HH")
         {
          ...
          if(vWorkingData[WatchIndexer] == "XX")
         {
           WatchVariableColIndex = 6;
         }
         ...
         if(WatchVariableColIndex < 7)
         {
           ...
           else
           {
            if(WatchVarableRowIndex == 7)
            {
              WVDC[WatchVariableColIndex].innerHTML = vWorkingData[WatchIndexer];
              ConvertFromString = parseInt(vWorkingData[WatchIndexer],10);
              YAxis[WatchVariableColIndex] = canHeight -  (ConvertFromString * canHeight)/(ChartUpperLimits[WatchVariableColIndex] - ChartLowerLimits[WatchVariableColIndex]);
            }
            else
            {
             WVD[WatchVarableRowIndex + (5* WatchVariableColIndex)].innerHTML = vWorkingData[WatchIndexer];
            }
            WatchVariableColIndex = WatchVariableColIndex + 1;
